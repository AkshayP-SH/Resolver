                ...
                <table className="table w-full">
                  ...
                  <tbody>
                    {complaints.map((complaint) => {
                      ...
                      return (
                        <tr key={complaint._id} className="group hover:bg-base-200/50 cursor-pointer border-b border-base-300/50 last:border-0 transition-colors">
                            ...
                            <button
                              ...
                              className={`flex items-center justify-center h-8 rounded-md border transition-all duration-200 overflow-hidden ${
                                hasUpvoted
                                  ...
                                  : 'bg-base-100 border-base-300 text-base-content/40 w-8 group-hover:w-16 group-hover:border-primary group-hover:text-primary'
                              }`}
                            >
...
function MyComplaintsView({ complaints, loading, onSelectComplaint, onUpvote }) {
  ...
  else if (filters.sort === 'priority') { const rank = { URGENT: 0, HIGH: 1, MEDIUM: 2, LOW: 3 }; sorted.sort((a, b) => (rank[a.priority] ?? 99) - (rank[b.priority] ?? 99)); } 
  ...
  return (
    <div>
      ...
      <div className="card bg-base-100 shadow-sm rounded-none border border-base-300">
        <div className="card-body p-0">
          {complaints.length === 0 ? <p className="text-center py-12 text-base-content/50 font-semibold">You haven't filed any complaints yet.</p> : paged.length === 0 ? <p className="text-center py-12 text-base-content/50 font-semibold">No complaints match your filters.</p> : (
            <>
              <div className="overflow-x-auto">
                <table className="table w-full">
                  <thead className="bg-base-200/50 border-b border-base-300">
  ...
  return (
    <div>
      ...
      <div className="card bg-base-100 border border-base-300 rounded-none">
        <div className="card-body p-0">
          {complaints.length === 0 ? <p className="text-center py-12 text-base-content/50 font-semibold">No complaints yet.</p> : (
            <div className="overflow-x-auto">
              <table className="table w-full">
                <thead className="bg-base-200/50 border-b border-base-300">
                  <tr>
